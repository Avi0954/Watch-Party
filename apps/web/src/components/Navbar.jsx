...
const Navbar = ({
  ...
  return (
    <nav className="w-full max-w-screen-2xl mx-auto px-2 sm:px-4 py-2 select-none">
      <div className="w-full bg-[#090B18] border-2 border-[#1E2442] rounded-2xl px-3 sm:px-5 py-2.5 flex items-center justify-between shadow-xl relative z-40">
